...
public class Southwest implements Airline {
    ...
    final private static Gate GATE = new Gate("Southwest");
    ...
    public static int getNoOfPassengers() {
        ...
        try {
            ...
            int index = textInFile.indexOf("SOUTHWEST");
            index += 10;
    ...
    public static String displayPassengers() {
        ...
        try {
            ...
            String textInFile = inputBuffer.toString();
            String textFlight = textInFile.substring(textInFile.indexOf("SOUTHWEST"), textInFile.indexOf("EOF") - 2);
